			...
			<section id="content">
					...
					<div class="orderInfo">
						<form method="post">
							...
							<div class="inputArea">
								<p>
									<input type="text"  name="userAddr1" id="sample6_postcode" placeholder="우편번호">
									<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br>
								</p>
								<p>	
									<input type="text" name="userAddr2" id="sample6_address" placeholder="주소"><br>
									<input type="text" name="userAddr3" id="sample6_detailAddress" placeholder="상세주소">
